...
CHANNEL_BOT_GUIDE = int(os.getenv('CHANNEL_BOT_GUIDE', 1470246404483055870))
CHANNEL_LOGS = int(os.getenv('CHANNEL_LOGS', 1471492956912353444))

# Owner
OWNER_ID = 980497294745030716
